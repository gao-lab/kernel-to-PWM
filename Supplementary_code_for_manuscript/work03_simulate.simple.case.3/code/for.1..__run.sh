...
# for.1..6.2.retrain.logistic.regression.R
# A maximum of 30 CPU cores will be used in this step.
${RSCRIPT_EXEC} ./for.1..6.2.retrain.logistic.regression.R

# for.1..6.3.plot.scatterplot.between.AUC.difference.and.motif.properties.for.training.and.validation.R
# A maximum of 20 CPU cores will be used in this step.
