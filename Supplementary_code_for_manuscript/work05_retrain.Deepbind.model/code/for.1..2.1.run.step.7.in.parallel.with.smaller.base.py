...
def calculate_direct_log_probability_for_single_input_sequence_and_single_PFM(temp_single_input_sequence_matrix, temp_single_PFM_matrix):    
...
def calculate_RC_log_probability_for_single_input_sequence_and_single_PFM(temp_single_input_sequence_matrix, temp_single_PFM_matrix):
    temp_RC_single_input_sequence_matrix = numpy.fliplr(numpy.flipud(temp_single_input_sequence_matrix))
    return calculate_direct_log_probability_for_single_input_sequence_and_single_PFM(temp_RC_single_input_sequence_matrix, temp_single_PFM_matrix)

def calculate_final_log_probability_for_single_input_sequence_and_single_PFM(temp_single_input_sequence_matrix, temp_single_PFM_matrix):
    direct_log_probability_float = calculate_direct_log_probability_for_single_input_sequence_and_single_PFM(temp_single_input_sequence_matrix, temp_single_PFM_matrix)
    RC_log_probability_float = calculate_RC_log_probability_for_single_input_sequence_and_single_PFM(temp_single_input_sequence_matrix, temp_single_PFM_matrix)
...
def calculate_exp_PFM_final_log_probability_for_each_row(temp_row_index_int):
    ...
    return calculate_final_log_probability_for_single_input_sequence_and_single_PFM(input_sequence_padded_with_one_quarter_on_both_sides_tensor[temp_single_input_sequence_index_int, :, :], exp_PFM_tensor[:, :, temp_single_PFM_index_int])
...
def calculate_Deepbind_PFM_final_log_probability_for_each_row(temp_row_index_int):
    ...
    if temp_single_input_sequence_index_int % 1000 == 0 :
        print(datetime.datetime.now().strftime("%H-%M-%S") + ": processing sample " + str(temp_single_input_sequence_index_int) + " and kernel " + str(temp_single_PFM_index_int))
    return calculate_final_log_probability_for_single_input_sequence_and_single_PFM(input_sequence_padded_with_one_quarter_on_both_sides_tensor[temp_single_input_sequence_index_int, :, :], Deepbind_PFM_tensor[:, :, temp_single_PFM_index_int])
...
temp_step_7_hdf5_output_filename = "../data/for.1..2.1.step.7.output.for.motif." + motif_id_str + ".hdf5"
