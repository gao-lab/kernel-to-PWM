...
exp_modelsave_output_filename = "../data/for.1..2.4.modelsave_for_exp_PFM_model_with_motif_" + motif_id_str + ".hdf5"
exp_checkpointer_output_filename = "../data/for.1..2.4.checkpointer_for_exp_PFM_model_with_motif" + motif_id_str + ".hdf5"
...
Deepbind_modelsave_output_filename = "../data/for.1..2.4.modelsave_for_Deepbind_PFM_model_with_motif_" + motif_id_str + ".hdf5"
Deepbind_checkpointer_output_filename = "../data/for.1..2.4.checkpointer_for_Deepbind_PFM_model_with_motif" + motif_id_str + ".hdf5"
...
testing_prediction_and_real_DataFrame.to_csv(path_or_buf="../data/for.1..2.4.testing.prediction.and.real.for.motif." + motif_id_str + ".txt", sep="\t", header=True, index=False)
